...
//#endif
	...
	Object obj;
	obj.VAO = loadSimpleOBJ("C:\\Users\\chris\\OneDrive\\Documentos\\unisinos\\CG2024-2-main\\Hello3D-OBJ\\Suzanne.obj",obj.nVertices);
	obj.model = glm::translate(obj.model, glm::vec3(-2.0f, 0.0f, 0.0f));
	

	Object obj2;
	obj2.VAO = loadSimpleOBJ("C:\\Users\\chris\\OneDrive\\Documentos\\unisinos\\CG2024-2-main\\Hello3D-OBJ\\Nave.obj",obj2.nVertices);
	obj2.model = glm::translate(obj2.model, glm::vec3(5.0f, 0.0f, 0.0f));
	...
	glUniform1f(glGetUniformLocation(shaderID, "kd"), 0.5f);
	glUniform1f(glGetUniformLocation(shaderID, "q"), 10.0f);

	//Propriedades da fonte de luz
	glUniform3f(glGetUniformLocation(shaderID,"lightPos"), -2.0f, 10.0f, 3.0f);
	glUniform3f(glGetUniformLocation(shaderID,"lightColor"), 10.0f, 8.0f, 1.0f);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if(objSelecionado == 0){
			...
			else if (moverAbaixo == 1)
			{
				obj.model = glm::translate(obj.model, glm::vec3(0.0f, -0.5f, 0.0f));
			}
